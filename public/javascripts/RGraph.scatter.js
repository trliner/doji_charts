            ...
            if (this.Get('chart.xaxispos') == 'center') {
                ...
                if (numYLabels == 1 || numYLabels == 3 || numYLabels == 5) {
                    ...
                    for (var i=0; i<numYLabels; ++i) {
                        RGraph.Text(context, font, text_size, xPos,gutter + ((canvas.height - (2 * gutter)) * (i/20) ),RGraph.number_format(this, this.max - (this.max * (i/10)), units_pre, units_post), 'center', align);
                        RGraph.Text(context, font, text_size, xPos,
                        
                        gutter + ((canvas.height - (2 * gutter)) * (i/20) ) + (this.grapharea / 2) + (this.grapharea / 20),
                        
                        '-' + RGraph.number_format(this, (this.max * (i/10)) + (this.max * (1/10)), units_pre, units_post), 'center', align);
                    }
                ...
                if (numYLabels == 1 || numYLabels == 3 || numYLabels == 5) {
                    ...
                    for (var i=0; i<numYLabels; ++i) {
                        RGraph.Text(context, font, text_size, xPos,gutter + ((canvas.height - (2 * gutter)) * (i/10) ),RGraph.number_format(this, this.max - (this.max * (i/10)), units_pre, units_post), 'center', align);
                    }
